...
abstract sig UseCase {
	...
	extensions = { e: Extension | 
        ...
        (ActionBlock <: ran[mainSuccessScenario.flow]).actionSteps[univ].(Choice <: extensions) +
        (ActionBlock <: ran[mainSuccessScenario.flow]).actionSteps[univ].(Concurrent <: extensions)}
}
